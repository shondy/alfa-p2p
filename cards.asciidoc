...
Тогда:
  выпадает список карт: карты Альфа-Банка клиента (alfabank = true) и те, с которых он ранее делал переводы (direction = sender).
....
...
Тогда:
  выпадает список карт: карты Альфа-Банка клиента (alfabank = true) и те, на которые он ранее делал переводы (direction = recipient).
....
===== Example request
